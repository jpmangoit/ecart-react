  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/carts' element={<ProtectedRoute Component={Cart} />} />
        <Route exact path='/profile' element={<ProtectedRoute Component={Profile} />} />
        <Route exact path='/my-account' element={<ProtectedRoute Component={MyProfile}  />} />
        <Route exact path='/my-address' element={<ProtectedRoute Component={MyAddress} />} />
        <Route exact path='/my-orders' element={<ProtectedRoute Component={MyOrder} />} />
        <Route exact path='/single-order' element={<ProtectedRoute Component={SingleOrder} />} />
        <Route exact path='/reset-password' element={<ProtectedRoute Component={ResetPassword} />} />
        <Route exact path='/thank-you' element={<ProtectedRoute Component={ThankYou} />} />
        {/* <Route exact path='/carts' element={<Cart />} /> */}
        <Route exact path='/checkout' element={<ProtectedRoute Component={Checkout} />} />
